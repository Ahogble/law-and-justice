    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-amber-500 selection:text-slate-950 flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-xl bg-amber-500 flex items-center justify-center text-slate-950 shadow-lg shadow-amber-500/20 font-bold">
            <Shield className="w-6 h-6 stroke-[2.5]" />
          </div>
          <div>
            <h1 className="font-serif font-bold text-lg text-white flex items-center gap-2">
              Droit & Justice <span className="text-xs font-sans px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20">Back-Office</span>
            </h1>
            <p className="text-xs text-slate-400">Système de gestion des contenus publics</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-3 py-2 text-xs text-slate-300 hover:text-amber-400 bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 rounded-xl transition-all flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-3 py-2 text-xs text-rose-400 hover:text-white bg-rose-500/10 hover:bg-rose-600 border border-rose-500/20 hover:border-rose-600 rounded-xl transition-all flex items-center gap-2 cursor-pointer font-medium"
          >
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto p-6 grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div className="md:col-span-1 space-y-2">
          <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider px-3 mb-2">Gestion des Rubriques</div>
          ...
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'articles' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <FileText className="w-4 h-4" />
            <span>Articles (Blog)</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{articles.length}</span>
          </button>

          <button
            onClick={() => { setActiveTab('members'); setIsEditing(false); }}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'members' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <Users className="w-4 h-4" />
            <span>Membres</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{members.length}</span>
          </button>

          <button
            onClick={() => { setActiveTab('categories'); setIsEditing(false); }}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'categories' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <FolderTree className="w-4 h-4" />
            <span>Catégories Membres</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{categoriesList.length}</span>
          </button>

          <button
            onClick={() => { setActiveTab('projects'); setIsEditing(false); }}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'projects' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <Briefcase className="w-4 h-4" />
            <span>Projets</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{projects.length}</span>
          </button>

          <button
            onClick={() => { setActiveTab('activities'); setIsEditing(false); }}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'activities' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <Calendar className="w-4 h-4" />
            <span>Activités & Agenda</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{activities.length}</span>
          </button>

          <button
            onClick={() => { setActiveTab('texts'); setIsEditing(false); }}
            className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
              activeTab === 'texts' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
            }`}
          >
            <BookOpen className="w-4 h-4" />
            <span>Textes Juridiques</span>
            <span className="ml-auto text-xs opacity-75 font-bold">{legalTexts.length}</span>
          </button>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-[11px] px-2 py-0.5 rounded-full bg-slate-800 text-amber-400 font-bold border border-amber-500/20">
            ...
            {/* Submenus List */}
            {isDisputesMenuOpen && (
              <div className="ml-3 pl-3 border-l-2 border-slate-800 space-y-1 pt-1">
                ...
                >
                  ...
                  <span className="ml-auto text-[10px] font-bold opacity-80">{disputeOfficers.length}</span>
                </button>
                ...
                >
                  ...
                  <span className="ml-auto text-[10px] font-bold opacity-80">{disputeCases.length}</span>
                </button>
                ...
                >
                  ...
                  <span className="ml-auto text-[10px] font-bold opacity-80">{stagesList.length}</span>
                </button>
              </div>
            )}
          </div>
          ...
          <div className="pt-4 border-t border-slate-800">
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-3 cursor-pointer ${
                activeTab === 'settings' ? 'bg-amber-500 text-slate-950 shadow-md shadow-amber-500/20' : 'text-slate-400 hover:bg-slate-900 hover:text-slate-200'
              }`}
            >
        ...
        {/* Main Content Area */}
        <div className="md:col-span-4 bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm">
          {flash?.message && (
          ...
          {activeTab === 'articles' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Articles & Publications</h2>
                  <p className="text-xs text-slate-400">Gérez les articles de doctrine et les actualités publiées.</p>
                </div>
                <button
                  onClick={() => {
                    setArticleForm({ id: '', title: '', category: 'Doctrine', excerpt: '', content: '', author_name: 'Hélène de Saint-Maur', author_role: 'Avocate', read_time: '5 min' });
                  ...
                  className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold text-xs rounded-xl flex items-center gap-2 cursor-pointer shadow-md shadow-amber-500/20"
                >
              ...
              {isEditing ? (
                <form onSubmit={handleSaveArticle} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                  <h3 className="font-semibold text-amber-400 text-sm mb-2">{articleForm.id ? 'Modifier l\'article' : 'Créer un nouvel article'}</h3>
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Résumé (Chapeau)</label>
                    <textarea
                      required
                      rows={2}
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Contenu complet</label>
                    <textarea
                      required
                      rows={5}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Auteur</label>
                      <input
                        type="text"
                  ...
                  <div className="flex gap-2 justify-end pt-2">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2"
                    >
              ...
              <div className="space-y-3">
                {articles.map((art: any) => (
                  <div key={art.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-start justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-[10px] uppercase font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20">{art.category}</span>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="p-2 text-slate-400 hover:text-amber-400 hover:bg-slate-900 rounded-lg transition-colors cursor-pointer"
                        title="Modifier"
                      >
          ...
          {activeTab === 'members' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Gestion des Membres</h2>
                  <p className="text-xs text-slate-400">Gérez les fiches des dirigeants et membres titulaires.</p>
                </div>
                <button
                  onClick={() => {
              ...
              {isEditing ? (
                <form onSubmit={handleSaveMember} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                  <h3 className="font-semibold text-amber-400 text-sm mb-2">{memberForm.id ? 'Modifier le membre' : 'Ajouter un membre'}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Rôle / Titre</label>
                      <input
                        type="text"
                        required
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Organisation / Institution</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Biographie</label>
                    <textarea
                      rows={3}
                  ...
                  <div className="flex gap-2 justify-end pt-2">
                    <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg">Annuler</button>
                    <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2"><Save className="w-4 h-4" /> Enregistrer</button>
                  </div>
                </form>
              ) : null}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {members.map((mem: any) => (
                  <div key={mem.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider">
                        {mem.category} {mem.subcategory ? `• ${mem.subcategory}` : ''}
                      </span>
                      <h4 className="font-bold text-white text-base">{mem.name}</h4>
                      <p className="text-xs text-slate-400">{mem.role}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <button onClick={() => { setMemberForm(mem); setIsEditing(true); }} className="p-2 text-slate-400 hover:text-amber-400"><Edit className="w-4 h-4" /></button>
                      <button onClick={() => handleDeleteMember(mem.id)} className="p-2 text-slate-400 hover:text-rose-400"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'categories' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Catégories & Sous-catégories de Membres</h2>
                  <p className="text-xs text-slate-400">Configurez les catégories principales et leurs sous-catégories (ex: Conseil d'Administration → National / Local).</p>
                </div>
              </div>

              {/* Add New Category Form */}
              <form onSubmit={handleAddCategory} className="bg-slate-950/80 p-5 rounded-xl border border-slate-800 mb-8 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Nom (Français)</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Nom (Anglais)</label>
                    <input
                      type="text"
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold text-xs rounded-xl flex items-center gap-2 cursor-pointer"
                  >
              ...
              <div className="space-y-6">
                {categoriesList.map(cat => (
                  <div key={cat.id} className="p-5 bg-slate-950/60 border border-slate-800 rounded-xl space-y-4">
                    ...
                    <div>
                      ...
                      {cat.subcategories.length > 0 ? (
                        <div className="flex flex-wrap gap-2 mb-4">
                          {cat.subcategories.map(sub => (
                            <span
                              key={sub.id}
                              className="inline-flex items-center gap-2 bg-slate-900 border border-slate-700/70 text-slate-200 text-xs px-3 py-1.5 rounded-lg"
                            >
                              <Tag className="w-3 h-3 text-amber-400" />
                              <span className="font-medium">{sub.name}</span>
                              <span className="text-[10px] text-slate-400">({sub.nameEn || sub.name})</span>
                              <button
                      ...
                      <form
                        ...
                        className="flex flex-col sm:flex-row items-center gap-2 bg-slate-900/50 p-3 rounded-lg border border-slate-800/80"
                      >
                        <input
                          type="text"
                          required
                          ...
                          className="w-full sm:w-48 px-2.5 py-1.5 bg-slate-950 border border-slate-800 rounded text-xs text-white"
                        />
                        <input
                          type="text"
                        ...
                        <button
                          type="submit"
                          className="w-full sm:w-auto px-3 py-1.5 bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/30 rounded text-xs font-semibold flex items-center justify-center gap-1.5 cursor-pointer ml-auto"
                        >
          ...
          {activeTab === 'projects' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Projets & Groupes de Travail</h2>
                  <p className="text-xs text-slate-400">Gérez les réformes et projets en cours.</p>
                </div>
                <button
                  onClick={() => {
                    setProjectForm({ id: '', title: '', category: 'Réforme', status: 'En cours', description: '', lead: '', progress: 50 });
              ...
              {isEditing ? (
                <form onSubmit={handleSaveProject} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                  <h3 className="font-semibold text-amber-400 text-sm mb-2">{projectForm.id ? 'Modifier le projet' : 'Ajouter un projet'}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Titre</label>
                      <input type="text" required value={projectForm.title} onChange={e => setProjectForm({ ...projectForm, title: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                    </div>
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Statut</label>
                      <select value={projectForm.status} onChange={e => setProjectForm({ ...projectForm, status: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white">
                  ...
                  <div>
                    ...
                    <textarea rows={3} required value={projectForm.description} onChange={e => setProjectForm({ ...projectForm, description: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                  </div>
                  <div className="flex gap-2 justify-end pt-2">
                    <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg">Annuler</button>
                    <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2"><Save className="w-4 h-4" /> Enregistrer</button>
              ...
              <div className="space-y-3">
                {projects.map((proj: any) => (
                  <div key={proj.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider">{proj.status}</span>
                      <h4 className="font-bold text-white text-base">{proj.title}</h4>
                      <p className="text-xs text-slate-400">{proj.description}</p>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <button onClick={() => { setProjectForm(proj); setIsEditing(true); }} className="p-2 text-slate-400 hover:text-amber-400"><Edit className="w-4 h-4" /></button>
                      <button onClick={() => handleDeleteProject(proj.id)} className="p-2 text-slate-400 hover:text-rose-400"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'activities' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Activités & Agenda</h2>
                  <p className="text-xs text-slate-400">Gérez les colloques, webinaires et événements.</p>
                </div>
                <button
                  onClick={() => {
                    setActivityForm({ id: '', title: '', type: 'Colloque', status: 'À venir', date: '', location: '', description: '' });
              ...
              {isEditing ? (
                <form onSubmit={handleSaveActivity} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                  <h3 className="font-semibold text-amber-400 text-sm mb-2">{activityForm.id ? 'Modifier l\'activité' : 'Ajouter une activité'}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Titre</label>
                      <input type="text" required value={activityForm.title} onChange={e => setActivityForm({ ...activityForm, title: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                    </div>
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Type</label>
                      <select value={activityForm.type} onChange={e => setActivityForm({ ...activityForm, type: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white">
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Description</label>
                    <textarea rows={3} required value={activityForm.description} onChange={e => setActivityForm({ ...activityForm, description: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                  </div>
                  <div className="flex gap-2 justify-end pt-2">
                    <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg">Annuler</button>
                    <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2"><Save className="w-4 h-4" /> Enregistrer</button>
              ...
              <div className="space-y-3">
                {activities.map((act: any) => (
                  <div key={act.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider">{act.type} • {act.status}</span>
                      <h4 className="font-bold text-white text-base">{act.title}</h4>
                      <p className="text-xs text-slate-400">{act.description}</p>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <button onClick={() => { setActivityForm(act); setIsEditing(true); }} className="p-2 text-slate-400 hover:text-amber-400"><Edit className="w-4 h-4" /></button>
                      <button onClick={() => handleDeleteActivity(act.id)} className="p-2 text-slate-400 hover:text-rose-400"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'texts' && (
            <div>
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                <div>
                  <h2 className="text-xl font-serif font-bold text-white">Textes Juridiques</h2>
                  <p className="text-xs text-slate-400">Gérez la revue de doctrine et la bibliothèque juridique.</p>
                </div>
                <button
                  onClick={() => {
                    setLegalTextForm({ id: '', title: '', reference: '', category: 'Doctrine', date: '', summary: '' });
              ...
              {isEditing ? (
                <form onSubmit={handleSaveLegalText} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                  <h3 className="font-semibold text-amber-400 text-sm mb-2">{legalTextForm.id ? 'Modifier le texte' : 'Ajouter un texte'}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Titre</label>
                      <input type="text" required value={legalTextForm.title} onChange={e => setLegalTextForm({ ...legalTextForm, title: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                    </div>
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Référence / ISSN</label>
                      <input type="text" value={legalTextForm.reference} onChange={e => setLegalTextForm({ ...legalTextForm, reference: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Résumé</label>
                    <textarea rows={3} required value={legalTextForm.summary} onChange={e => setLegalTextForm({ ...legalTextForm, summary: e.target.value })} className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white" />
                  </div>
                  <div className="flex gap-2 justify-end pt-2">
                    <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg">Annuler</button>
                    <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2"><Save className="w-4 h-4" /> Enregistrer</button>
              ...
              <div className="space-y-3">
                {legalTexts.map((lt: any) => (
                  <div key={lt.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider">{lt.category} • {lt.reference}</span>
                      <h4 className="font-bold text-white text-base">{lt.title}</h4>
                      <p className="text-xs text-slate-400">{lt.summary}</p>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <button onClick={() => { setLegalTextForm(lt); setIsEditing(true); }} className="p-2 text-slate-400 hover:text-amber-400"><Edit className="w-4 h-4" /></button>
                      <button onClick={() => handleDeleteLegalText(lt.id)} className="p-2 text-slate-400 hover:text-rose-400"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 pb-4 border-b border-slate-800 gap-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400">Configurez les intervenants neutres (Conciliateurs, Médiateurs, Arbitres) et les dossiers de litiges internes & externes.</p>
                </div>
              ...
              {/* Sub-tabs header */}
              <div className="flex items-center gap-2 mb-6 bg-slate-950/80 p-1.5 rounded-xl border border-slate-800">
                <button
                ...
                >
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-900/40 font-bold">{disputeOfficers.length}</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-900/40 font-bold">{disputeCases.length}</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-900/40 font-bold">{stagesList.length}</span>
                </button>
              </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-slate-950/80 p-4 rounded-xl border border-slate-800 space-y-3">
                      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
                        ...
                        <div className="relative flex-1">
                          ...
                          <input
                            ...
                            className="w-full pl-9 pr-8 py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs text-white placeholder-slate-500 focus:outline-none focus:border-amber-500"
                          />
                          {officerSearchQuery && (
                            <button
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            className="px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs text-white focus:outline-none focus:border-amber-500 cursor-pointer"
                          >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            className="px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs text-white focus:outline-none focus:border-amber-500 font-medium cursor-pointer"
                          >
                      ...
                      <div className="flex items-center justify-between text-[11px] text-slate-400 pt-1 border-t border-slate-900">
                        <span>Affichage de <strong className="text-amber-400">{filteredOfficers.length}</strong> sur <strong>{disputeOfficers.length}</strong> intervenants enregistrés</span>
                    ...
                    {isEditing ? (
                      <form onSubmit={handleSaveDisputeOfficer} className="space-y-4 bg-slate-950/90 p-6 rounded-2xl border border-amber-500/40 mb-6 shadow-xl">
                        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                          <h3 className="font-semibold text-amber-400 text-sm flex items-center gap-2">
                            <UserPlus className="w-4 h-4 text-amber-400" />
                            <span>{disputeOfficerForm.id ? 'Modifier l\'officiel' : 'Enregistrer un Conciliateur / Médiateur / Arbitre'}</span>
                          </h3>
                          <span className="text-[11px] text-slate-400">Formulaire complet (Conforme Image 2)</span>
                        </div>
                        
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Nom complet (ex: Me Gabriel Leroy)</label>
                            <input
                              type="text"
                              required
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Intitulé du Titre / Badge Status (ex: CONCILIATEUR SENIOR)</label>
                            <input
                              type="text"
                              required
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Fonction Principale</label>
                            <select
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Étape Procédurale</label>
                            <select
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Statut Disponibilité</label>
                            <select
                              value={disputeOfficerForm.availability}
                              onChange={e => setDisputeOfficerForm({ ...disputeOfficerForm, availability: e.target.value })}
                              className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-emerald-400 font-semibold focus:outline-none focus:border-amber-500"
                            >
                              <option value="Disponible">Disponible</option>
                              <option value="Sur RDV">Sur RDV</option>
                              <option value="En audience">En audience</option>
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-slate-300 mb-1">Description du Rôle / Barreau / Mandat (ex: Avocat au Barreau de Paris & Membre de la Commission d'Éthique)</label>
                          <input
                            type="text"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Expérience (années de pratique)</label>
                            <input
                              type="number"
                              min="0"
                          ...
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Dossiers traités (nombre d'affaires)</label>
                            <input
                              type="number"
                              min="0"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-xs font-semibold text-slate-300 mb-1">Spécialités / Domaines d'intervention (séparés par des virgules)</label>
                            <input
                              type="text"
                        ...
                        <div className="flex gap-2 justify-end pt-3 border-t border-slate-800">
                          <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg cursor-pointer">Annuler</button>
                          <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2 cursor-pointer shadow-md shadow-amber-500/20"><Save className="w-4 h-4" /> Enregistrer l'Intervenant</button>
                        </div>
                      </form>
                    ) : null}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      {filteredOfficers.map((off: any) => {
                        ...
                        return (
                          <div
                            key={off.id}
                            className="bg-white text-slate-900 border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
                          >
                            <div>
              ...
              {disputeSubTab === 'cases' && (
                <div>
                  {isEditing ? (
                    <form onSubmit={handleSaveDisputeCase} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                      <h3 className="font-semibold text-amber-400 text-sm mb-2">{disputeCaseForm.id ? 'Modifier l\'affaire' : 'Créer une affaire de litige'}</h3>
                      
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">N° de Dossier / Référence</label>
                          <input
                            type="text"
                            required
                        ...
                        <div className="sm:col-span-2">
                          <label className="block text-xs text-slate-400 mb-1">Intitulé de l'Affaire</label>
                          <input
                            type="text"
                            required
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Étape Procédurale</label>
                          <select
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Visibilité Publique / Confidentielle</label>
                          <select
                            value={disputeCaseForm.is_public ? 'true' : 'false'}
                            onChange={e => setDisputeCaseForm({ ...disputeCaseForm, is_public: e.target.value === 'true' })}
                            className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-sm text-white font-medium"
                          >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Statut Procédural</label>
                          <select
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Parties impliquées</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Officiel Assigné</label>
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="block text-xs text-slate-400 mb-1">Synthèse / Résumé du Litige</label>
                        <textarea
                          required
                          rows={3}
                      ...
                      <div>
                        <label className="block text-xs text-slate-400 mb-1">Notice de Confidentialité (Pour affaires non publiques)</label>
                        <input
                          type="text"
                      ...
                      <div className="flex gap-2 justify-end pt-2">
                        <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg cursor-pointer">Annuler</button>
                        <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2 cursor-pointer"><Save className="w-4 h-4" /> Enregistrer le Dossier</button>
                      </div>
                    </form>
                  ) : null}
                  ...
                  <div className="space-y-3">
                    {disputeCases.map((c: any) => {
                      ...
                      return (
                        <div key={c.id} className="p-4 bg-slate-950/60 border border-slate-800/80 rounded-xl flex items-center justify-between gap-4">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-[10px] font-mono font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20">{c.case_number || c.caseNumber || c.id}</span>
                              <span className="text-[10px] uppercase font-bold text-slate-400">{c.category} • {c.stage}</span>
                              {isPub ? (
                                <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded flex items-center gap-1"><Unlock className="w-3 h-3" /> Publique</span>
                              ) : (
                                <span className="text-[10px] font-bold text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded flex items-center gap-1"><Lock className="w-3 h-3" /> Confidentielle</span>
                              )}
              ...
              {disputeSubTab === 'stages' && (
                <div>
                  {isEditing ? (
                    <form onSubmit={handleAddOrUpdateStage} className="space-y-4 bg-slate-950/80 p-6 rounded-xl border border-slate-800 mb-6">
                      <h3 className="font-semibold text-amber-400 text-sm mb-2">{disputeStageForm.id ? 'Modifier l\'étape' : 'Créer une nouvelle étape de litige'}</h3>
                      
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Numéro d'Étape (ex: Étape 1)</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Clé identifiante (ex: conciliation)</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Intitulé des Intervenants</label>
                          <input
                            type="text"
                            required
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Titre de l'étape (Cadre Réglementaire)</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Sous-titre / Court descriptif</label>
                          <input
                            type="text"
                            required
                      ...
                      <div>
                        <label className="block text-xs text-slate-400 mb-1">Description détaillée (Procédure Officielle)</label>
                        <textarea
                          required
                          rows={3}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Base juridique</label>
                          <input
                            type="text"
                            required
                        ...
                        <div>
                          <label className="block text-xs text-slate-400 mb-1">Garantie de confidentialité</label>
                          <input
                            type="text"
                            required
                      ...
                      <div className="flex gap-2 justify-end pt-2">
                        <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-slate-800 text-slate-300 text-xs font-semibold rounded-lg cursor-pointer">Annuler</button>
                        <button type="submit" className="px-4 py-2 bg-amber-500 text-slate-950 text-xs font-semibold rounded-lg flex items-center gap-2 cursor-pointer"><Save className="w-4 h-4" /> Enregistrer l'Étape</button>
                      </div>
                    </form>
                  ) : null}
                  ...
                  <div className="space-y-4">
                    {stagesList.map((stg: any) => (
                      <div key={stg.id} className="p-5 bg-slate-950/60 border border-slate-800 rounded-xl space-y-3">
                        <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
                          <div className="flex items-center gap-3">
                            <span className="text-xs font-bold uppercase tracking-wider bg-amber-500/20 text-amber-400 px-2.5 py-1 rounded-lg border border-amber-500/30">
                              {stg.stepNumber}
                            </span>
                            <div>
                              <h4 className="font-bold text-white text-base">{stg.title}</h4>
                              <p className="text-xs text-slate-400">{stg.subtitle}</p>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs pt-1">
                          <div className="bg-slate-900/80 p-2.5 rounded-lg border border-slate-800">
                            ...
                            <span className="text-slate-200 font-semibold">{stg.legalBasis}</span>
                          </div>
                          <div className="bg-slate-900/80 p-2.5 rounded-lg border border-slate-800">
                            <span className="text-slate-500 block font-medium">Confidentialité</span>
                            <span className="text-slate-200 font-semibold">{stg.confidentiality}</span>
                          </div>
                          <div className="bg-slate-900/80 p-2.5 rounded-lg border border-slate-800">
                            <span className="text-slate-500 block font-medium">Titre des Intervenants</span>
                            <span className="text-amber-400 font-semibold">{stg.officersTitle}</span>
                          </div>
                        </div>
                      </div>
                    ))}
          ...
          {activeTab === 'settings' && (
            <div>
              <div className="mb-6 pb-4 border-b border-slate-800">
                <h2 className="text-xl font-serif font-bold text-white">Éditer les Textes des Pages Publiques</h2>
                <p className="text-xs text-slate-400">Modifiez instantanément le titre principal, les présentations et les coordonnées du site.</p>
              </div>
              ...
              <form onSubmit={handleSaveSettings} className="space-y-6">
                <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-5 space-y-4">
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Titre principal (Hero Title)</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Sous-titre explicatif (Hero Subtitle)</label>
                    <textarea
                      rows={2}
                ...
                <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-5 space-y-4">
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">Texte de Présentation de l'Association</label>
                    <textarea
                      rows={3}
                ...
                <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Email Officiel</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs text-slate-400 mb-1">Adresse Siège</label>
                      <input
                        type="text"
                ...
                <div className="flex justify-end pt-2">
                  <button
                    type="submit"
                    className="px-6 py-3 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-sm rounded-xl shadow-lg shadow-amber-500/20 flex items-center gap-2 cursor-pointer transition-all"
                  >
